...
let cardArray = [{img:"img0.jpg", appName:"Expense Tracker", appLines:"Easily log daily expenses, categorize spending, and visualize your budget with clear insights.", link:""},
                 {img:"img1.jpg", appName:"Quiz App", appLines:"Challenge yourself with fun quizzes across multiple categories.", link:"tic.html"},
...
for(let i=0; i<cardArray.length;i++){
    ...
    <div class="apps-card">
        ...
        <div class="btn">
            <button class="start-btn" onclick="showOverlay()"><a href="./pages/games/${cardArray[i].link}"}>Start Now</a></button>
        </div>
    </div>
    </div>
    `;
