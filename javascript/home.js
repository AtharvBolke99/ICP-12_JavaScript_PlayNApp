...
let cardArray = [{img:"expense.png", appName:"Expense Tracker", appLines:"Easily log daily expenses and visualize your budget with clear insights.", link:""},
                 {img:"quiz.png", appName:"Quiz App", appLines:"Challenge yourself with fun quizzes across multiple categories.", link:"tic.html"},
                 {img:"todo.png", appName:"Todo List", appLines:"Easily create, manage, and prioritize tasks in one place.", link:""},
                 {img:"calculator.jpg", appName:"Build Calculator", appLines:"Perform advanced calculations with ease SmartCalc is your reliable everyday.", link:""},
                 {img:"bmi_calculator.png", appName:"BMI Calculator", appLines:"Quickly calculate your Body Mass Index to understand your fitness level.", link:""},
                 {img:"text_op.jpg", appName:"Text Operation", appLines:"Easily transform, format, and analyze your text with handy tools.", link:""},
                 {img:"clock.jpg", appName:"Digital Clock", appLines:"A clean and modern digital clock for your screen.", link:""},
                 ...
                 {img:"torch.jpg", appName:"Torch", appLines:"Light up your way with a simple digital torch.", link:""},
    ];
for(let i=0; i<cardArray.length;i++){
    ...
    <div class="apps-card">
        ...
        <div class="btn">
            <button class="start-btn" onclick="showOverlay()"><a class="link-tag" href="./pages/games/${cardArray[i].link}"}>Start Now</a></button>
        </div>
    </div>
    </div>
    `;
...
let gameArray = [{gameimg:"tic_tac_toe.jpg", gameName:"Tic-Tac-Toe", gameLines:"Play the classic X and O game and test your strategy.", link:""},
