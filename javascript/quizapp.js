const questions = [
    {
        question: "Which of the following cities is known as the 'Pink City' of India?",
        answers: [{ text: "Mysuru", correct: true },
    ...
    {
        question: "In which state of India is the famous Sun Temple located?",
        answers: [{ text: "Odisha", correct: true },
    ...
    {
        question: "What was the capital of Chhatrapati Shivaji Maharaj's kingdom?",
        answers: [{ text: "Pratapgad Fort", correct: true },
        { text: "Raigad Fort", correct: false },
        { text: "Shaniwar Wada", correct: false },
        { text: "Shivneri Fort", correct: false }]
    }
];
